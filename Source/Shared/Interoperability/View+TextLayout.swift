...
public extension ViewClass {
    ...
    @discardableResult
    public func alignTop(for style: TextStyle, toBottomOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignTop(for style: TextStyle, toTopOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignTop(for style: TextStyle, toBottomOf targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignTop(for style: TextStyle, toBaselineOf targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignTop(toBaselineOf style: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        return alignTop(toBaselineOf: targetView, offset: -metrics.textMargins.top + offset)
    }
    ...
    @discardableResult
    public func alignLeading(for style: TextStyle, toLeadingOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignLeading(for style: TextStyle, toTrailingOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignTrailing(for style: TextStyle, toTrailingOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignTrailing(for style: TextStyle, toLeadingOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignLeft(for style: TextStyle, toLeftOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignLeft(for style: TextStyle, toRightOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignRight(for style: TextStyle, toRightOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
    ...
    @discardableResult
    public func alignRight(for style: TextStyle, toLeftOf targetStyle: TextStyle, targetView: ViewClass, width: CGFloat = CGFloat.greatestFiniteMagnitude, offset: CGFloat = 0.0) -> NSLayoutConstraint {
        let boundBy = CGSize(width: width, height: CGFloat.greatestFiniteMagnitude)
        let metrics = TextMetricsCache.shared.textMetrics(for: style, textType: .label, boundBy: boundBy)
        let targetMetrics = TextMetricsCache.shared.textMetrics(for: targetStyle, textType: .label, boundBy: boundBy)
