...
extension NSEdgeInsets {
    static public let zero = NSEdgeInsets(top: 0.0, left: 0.0, bottom: 0.0, right: 0.0)
}
...
class TextMetricsCalculator: NSObject, NSLayoutManagerDelegate {
    ...
    private var characterFonts = [Int: HPFont]()
    ...
    private func updateHorizontalInsets(_ metrics: TextMetrics, with font: HPFont) -> TextMetrics {
    ...
    func layoutManager(_ layoutManager: NSLayoutManager, shouldGenerateGlyphs glyphs: UnsafePointer<CGGlyph>, properties props: UnsafePointer<NSLayoutManager.GlyphProperty>, characterIndexes charIndexes: UnsafePointer<Int>, font aFont: HPFont, forGlyphRange glyphRange: NSRange) -> Int {
