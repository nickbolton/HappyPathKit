...
public enum SystemFontWeight: String {
    ...
    private static let weightMap: [SystemFontWeight: HPFont.Weight] = [
        .regular: .regular,
        .italic: .regular,
    ...
    public var fontWeight: HPFont.Weight {
...
public struct TextAttributes {
    ...
    public init() {
        self.font = HPFont.systemFont(ofSize: TextAttributes.defaultFontSize)
        self.kerning = 0.0
    ...
    public init(font: HPFont,
                textColor: HPColor = .clear,
    ...
    public init(systemFontWeight: SystemFontWeight,
                ...
                underlineStyle: Int = 0,
                isStrikeThrough: Bool = false) {
        self.font = HPFont.systemFont(systemFontWeight: systemFontWeight, pointSize: pointSize)
        self.kerning = kerning
        self.lineHeightMultiple = lineHeightMultiple
        self.paragraphSpacing = paragraphSpacing
        self.baselineOffset = baselineOffset
